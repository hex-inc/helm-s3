...
func (idx *IndexV3) Add(metadata interface{}, filename string, baseURLs []string, digest string) error {
...
func (idx *IndexV3) AddOrReplace(metadata interface{}, filename string, baseURLs []string, digest string) error {
